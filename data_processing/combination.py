...
def getData(DATA_FILE):
    ...
    for pcap_file in os.listdir(DATA_FILE):
        ...
        local_ip = ['192.168.247.139', '192.168.125.100', '192.168.25.129', '192.168.88.128', '192.168.139.131', '192.168.101.129'
                    , '172.19.0.2', '192.168.238.129', '192.168.248.129', '192.168.200.138', '192.168.125.100', '192.168.195.128']  # 本机的ip，就是数据包的目的ip
...
DATA_FILE = "../Pcap/final/bing/3/"
CSV_FILE = "../DataSet/combination/final/bing/3/bing.csv"
